...
systemctl stop gost-panel gost 2>/dev/null || true
systemctl disable gost-panel gost 2>/dev/null || true
rm -f /etc/systemd/system/gost-panel.service /etc/systemd/system/gost.service
